...
def get_list_recurrence(A):
    return ([(2*A[0][0]-2*A[0][1], 2*A[0][0]-2*A[1][0]),                                    #a00/a00---Line 3
            ...
            (4*A[1][0]-2*A[1][1], 3*A[1][0]+2*A[1][1], 3*A[1][0]+2*A[1][1]),                #cycle of same color---Line 12
            (4*A[0][1]-2*A[1][1], 3*A[0][1]+2*A[1][1], 3*A[0][1]+2*A[1][1]), 
            (3*A[0][1], 2*A[0][1]-2*A[1][1]),                                               #triangles---Line 14
            (3*A[1][0], 2*A[1][0]-2*A[1][1])
            ])
    ...
    for e1 in range(N+1):
        for e2 in range(N+1):
            ...
            if a10 >1:
                a10=1
            a01 = a10
            a11 = e2/(N*interval)+starting_points[2]-1/(2*interval)
            if a11 >1:
                a11=1
